...
INSERT INTO projetointegrador.eventos
    (usuarios_id,nomeEvento, duracao, exibicao,url ,timeZone )
VALUES
    (1, 'Iagoevento',30,60,'iago','brasil'),
    (2, 'Caioevento',30,60,'caio','brasil'),
    (3, 'Alexandreevento',30,60,'alexandre','brasil');
